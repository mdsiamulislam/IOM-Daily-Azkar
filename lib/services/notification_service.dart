...
import '../main.dart'; // For debugPrint
...
class NotificationService {
  ...
  static Future<void> initializeNotifications() async {
    ...
    await _flutterLocalNotificationsPlugin.initialize(
      ...
      // This is for notifications tapped when the app is terminated/backgrounded.
      // The function `notificationTapBackground` must be a top-level function in main.dart.
