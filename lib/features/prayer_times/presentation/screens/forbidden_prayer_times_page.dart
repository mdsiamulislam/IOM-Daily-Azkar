...
import 'package:iomdailyazkar/core/constants/constants.dart';
        ...
        import 'package:iomdailyazkar/core/theme/app_text_styles.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextStyles.regular.copyWith(fontSize: 16, color: Colors.black87),
                    ...
                    _buildForbiddenTimeSection(
                      ...
                      'আসরের নামাজ আদায় করার পর থেকে সূর্য সম্পূর্ণ অস্ত না যাওয়া পর্যন্ত নফল নামাজ পড়া হারাম। তবে এই সময়ে কাজা নামাজ বা জানাজা�� নামাজ পড়া জায়েজ।',
                    ),
                    const SizedBox(height: 20),

                    Text(
                      'গুরুত্বপূর্ণ নোট:',
                      style: AppTextStyles.bold.copyWith(fontSize: 18, color: Colors.black),
                    ),
                    ...
                    Text(
                      ...
                      style: AppTextStyles.regular.copyWith(fontSize: 15, color: Colors.blueAccent),
                      textAlign: TextAlign.justify,
                    ),
                    const SizedBox(height: 20),

                    Text(
                      'এই নির্দেশিকাটি আপনাকে নামাজের নিষিদ্ধ সময় সম্পর্কে একটি স্পষ্ট ধারণা দিতে সাহায্য ক��বে।',
                      style: AppTextStyles.regular.copyWith(fontSize: 15, color: Colors.black),
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    title,
                    style: AppTextStyles.bold.copyWith(fontSize: 17, color: Colors.red),
                  ),
                  const SizedBox(height: 8),
                  Text(
                    description,
                    style: AppTextStyles.regular.copyWith(fontSize: 15, color: Colors.black87),
                    textAlign: TextAlign.justify,
                  ),
                ],
              ),
